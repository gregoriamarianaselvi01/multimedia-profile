...
<div id="layoutSidenav_content">
                                        ...
                                        <?php foreach ($daftar_kategori as $kategori) : ?>
                                            <tr>
                                                ...
                                                <td width="15%" class="text-center">
                                                    ...
                                                    data-bs-toggle="modal" data-bs-target="#ubahModal<?= $kategori->id_kategori; ?>"><i class="fas fa-edit"></i></button>
                                                    <button type="button" class="btn btn-danger btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#hapusModal"><i class="fas fa-trash-alt"></i></button>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
        ...
        <!-- Modal Ubah -->
        <?php foreach ($daftar_kategori as $kategori) : ?>
        <div class="modal fade" id="ubahModal<?= $kategori->id_kategori; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
